...
- This is the first in a three-part series on digital modeling practices in Urban Design
- Meant to introduce UD Digital Practice Initiative (DPI), goals, challenges and ideas
- Sessions 2 and 3 are planned as tutorials for UDTools and will be held in late March
...
The traditional way this happens is through drawings and models, I'm also super interested in new mediums like websites, games and tools like GIS and BIM as ways of doing this. Especially the first two, since they're becoming more and more accessible and democratic.
...
For additional help, contact Crystal Eksi for one-on-one trainings and project support. Requests for more extensive collaborations should be directed to Erick Gregory, and Carsten Rodin is available on a limited basis to discuss tool-specific issues and ideas for future development.
